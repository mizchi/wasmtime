    ...
    fn initializer(
        ...
        match initializer {
            ...
            ThreadSpawnIndirect {
                ...
                let index = self.result.trampolines.push((
                    *func,
                    dfg::Trampoline::ThreadSpawnIndirect {
                        instance: frame.instance,
                        shared: *shared,
                        start_func_ty_idx: *start_func_ty,
                        start_func_table_id: table_id,
            ...
            ThreadAvailableParallelism { func, shared } => {
                let index = self.result.trampolines.push((
                    *func,
                    dfg::Trampoline::ThreadAvailableParallelism { shared: *shared },
                ));
                frame.funcs.push((*func, dfg::CoreDef::Trampoline(index)));
            }
